...
# Para o teste, usamos 10. Para o projeto final, mude para 50.
num_entrevistados = 10 

print("--- Início da Pesquisa TudoWeb ---")
print(f"Total de entrevistados a serem ouvidos: {num_entrevistados}")

# Estrutura de Repetição FOR
# 'range(1, num_entrevistados + 1)' garante que o contador vá de 1 até o número total
for i in range(1, num_entrevistados + 1):
    print(f"\nEntrevistado nº {i}")
    
    # Coleta de dados
    nome = input("Digite o nome: ")
    idade = input("Digite a idade: ") # Recebemos como texto para não travar se digitarem letra
    ...
    # A opção "2" não precisa ser contada de acordo com o pedido.
    # Qualquer outra resposta diferente de 1 ou 3 não altera os contadores.
